...
public class PasswordStorage {
    ...
    public static String createHash(String password) {
        ...
        try {
            s = createHash(password.toCharArray());
        } catch (CannotPerformOperationException ex) {
            ex.printStackTrace();
            log.warn("Exception catched in createHash");
        }
        return s;
    }
    ...
    public static boolean verifyPassword(String password, String correctHash) {
        ...
        try {
            b = verifyPassword(password.toCharArray(), correctHash);
        } catch (CannotPerformOperationException | InvalidHashException ex) {
            ex.printStackTrace();
            log.warn("Exception catched in verifyPassword");
        }
        return b;
    }
